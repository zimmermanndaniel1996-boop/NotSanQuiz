...
// Zieht "count" zufällige Fragen aus dem gesamten Fragenpool (ohne
// Lösung) - für den "The Brain"-Modus, unabhängig vom Lernfortschritt.
export function getRandomPublicQuestions(count) {
  const all = getAllPublicQuestions();
  const shuffled = [...all];
